// Copia de respaldo de app/components/WhatsAppButton.tsx
"use client";
...
export default function WhatsAppButton() {
  ...
  return (
    <a href={href} target="_blank" rel="noopener noreferrer" aria-label="Escríbenos por WhatsApp" className="fixed bottom-6 right-6 z-50">
      <span className="grid place-items-center h-14 w-14 rounded-full bg-[#25D366] shadow-lg ring-1 ring-black/10 hover:shadow-xl hover:brightness-95 transition">
        <svg width="28" height="28" viewBox="0 0 24 24" aria-hidden="true" fill="currentColor" className="text-white">
